...
// 2020-05-20 <vrillusions@nospam.google.com> modified SHT11 code for SHT21 (I think)
...
/** Take a measurement.
 *  @param type SHT21::TEMP or SHT21::HUMI
...
void SHT21::calculate(float& rh_true, float& t_C) const {
    ...
    t_C = (((175.72 * (float)meas[TEMP]) / 65536.0) - 46.85); //t= -46.85 + 175.72 * ST/2^16

    float rh = meas[HUMI];
    rh_true = -6.0 + (125.0/65536.0 * rh); //RH= -6 + 125 * SRH/2^16
